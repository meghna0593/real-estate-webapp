...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone number"), max_length=30, default="+19000000000")
    ...
    num_reviews = models.IntegerField(verbose_name=_("Number of Review"), default=0)
