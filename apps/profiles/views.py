...
class AgentListAPIView(generics.ListAPIView):  # class based views
...
class GetProfileAPIView(APIView):
    ...
    def get(self, request):
        ...
        return Response(serializer.data, status=status.HTTP_200_OK)  # will be under the profile namespace
