# Generated by Django 3.2.7 on 2024-06-04 22:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref_code', models.CharField(blank=True, max_length=255, unique=True, verbose_name='Property Refernce Code')),
                ...
                ('city', models.CharField(default='Vancouver', max_length=180, verbose_name='City')),
                ...
                ('property_number', models.CharField(blank=True, max_length=5, null=True, verbose_name='Propert Number')),
                ...
                ('plot_area', models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='Plot Area (m^2)')),
                ...
                ('property_type', models.CharField(choices=[('House', 'House'), ('Town Home', 'Town Home'), ('Apartment', 'Apartment'), ('Office', 'Office'), ('Warehouse', 'Warehouse'), ('Commercial', 'Commercial'), ('Other', 'Other')], default='Other', max_length=50, verbose_name='Property Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('photo', models.ImageField(blank=True, default='/interior_sample.jpg', null=True, upload_to='', verbose_name='Property Photo')),
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='property_photo', to='properties.property')),
            ],
            options={
                'abstract': False,
            },
