...
class PropertyType(models.TextChoices):
    HOUSE = "House", _("House")
    TOWN_HOME = "Town Home", _("Town Home")
...
class Property(TimeStampedUUIDModel):
    ...
    ref_code = models.CharField(verbose_name=_("Property Refernce Code"), max_length=255, unique=True, blank=True)
    description = models.TextField(verbose_name=_("Description"), default="Default Description...update me please...")
    country = CountryField(verbose_name=_("Country"), default="CA", blank_label="(select country)")
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Vancouver")
    postal_code = models.CharField(verbose_name=_("Postal Code"), max_length=100, default="140")
    street_address = models.CharField(verbose_name=_("Street Address"), max_length=100, blank=True, null=True)
    property_number = models.CharField(verbose_name=_("Propert Number"), blank=True, null=True, max_length=5)
    price = models.DecimalField(verbose_name=_("Price"), max_digits=8, decimal_places=2, blank=True, null=True)
    ...
    plot_area = models.DecimalField(
        verbose_name=_("Plot Area (m^2)"), max_digits=8, decimal_places=2, blank=True, null=True
    )
    ...
    cover_photo = models.ImageField(verbose_name=_("Main Photo"), default="/house_sample.jpg", blank=True, null=True)
    ...
    def save(self, *args, **kwargs):
        ...
        if "photos" in kwargs:
            ...
            for photo in photos:
                PropertyPhoto.objects.create(property=self, photo=photo)
...
class PropertyPhoto(TimeStampedUUIDModel):
    property = models.ForeignKey(Property, related_name="property_photo", on_delete=models.CASCADE)
    photo = models.ImageField(verbose_name=_("Property Photo"), default="/interior_sample.jpg", blank=True, null=True)
